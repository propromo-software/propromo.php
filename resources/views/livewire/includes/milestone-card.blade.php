<div class="px-6 py-4 border-2 rounded-xl border-other-grey w-max" wire:key="{{$milestone['title']}}}">
    ...
    @if($milestone['progress'] >= 80)
        <div class="flex justify-between">
            <div class="text-additional-green font-sourceSansPro font-bold">{{$milestone['open_issues_count']}}/{{$milestone['open_issues_count']+$milestone['closed_issues_count']}} Tasks</div>
        ...
        @elseif($milestone['progress'] >= 50)
            ...
            <div class="flex justify-between">
                <div class="text-additional-orange font-sourceSansPro font-bold">{{$milestone['closed_issues_count']}}/{{$milestone['open_issues_count']+$milestone['closed_issues_count']}} Tasks</div>
        ...
        @else
            ...
            <div class="flex justify-between">
                <div class="text-additional-red font-sourceSansPro font-bold">{{$milestone['closed_issues_count']}}/{{$milestone['open_issues_count']+$milestone['closed_issues_count']}} Tasks</div>
